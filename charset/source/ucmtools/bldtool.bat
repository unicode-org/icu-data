...
cl -nologo -MD -I..\..\..\..\icu\source\common -I..\..\..\..\icu\source\tools\toolutil -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE %1 -link /LIBPATH:..\..\..\..\icu\lib icuuc.lib icutu.lib
